...
- **Premium Hybrid Haptics**: 
    - **Physical Haptics**: Tactile vibrations for mobile users via `web-haptics`.
    - **Mechanical Audio**: Synthesized "click" sounds for desktop users for a tactile feel across all devices.
...
3.  **View in Browser**:
    ...
    - Network: `http://192.168.x.x:5173` (Check your terminal for the exact IP)

## 🛠 Tech Stack

- **Framework**: [Svelte](https://svelte.dev/) (with TypeScript support)
- **Styling**: [Tailwind CSS](https://tailwindcss.com/)
- **Haptics**: [Web-Haptics](https://haptics.lochie.me/) & Web Audio API
